/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d622d5eccf212c1db6a1f56baed09087)
// Runtime types generated with workerd@1.20260908.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: R2Bucket;
	DB: D1Database;
	TASK_QUEUE: Queue;
	ENVIRONMENT: "staging" | "production";
	PUBLIC_API_BASE_URL: "https://noxspot-api-staging.jasper-414.workers.dev" | "https://api.noxspot.dev";
	PUBLIC_ASSET_BASE_URL: "https://noxspot-api-staging.jasper-414.workers.dev" | "https://cdn.noxspot.dev";
	BUILD_SHA: "development";
	RATE_LIMITER: DurableObjectNamespace<import("./src/index").RateLimiter>;
	NOXCONNECT: Fetcher /* noxconnect-capabilities-staging */ | Fetcher /* noxconnect-capabilities */;
	NOXCUE_INGEST: Fetcher /* noxcue-staging */ | Fetcher /* noxcue */;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		TASK_QUEUE: Queue;
		ENVIRONMENT: "staging";
		PUBLIC_API_BASE_URL: "https://noxspot-api-staging.jasper-414.workers.dev";
		PUBLIC_ASSET_BASE_URL: "https://noxspot-api-staging.jasper-414.workers.dev";
		BUILD_SHA: "development";
		RATE_LIMITER: DurableObjectNamespace<import("./src/index").RateLimiter>;
		NOXCONNECT: Fetcher /* noxconnect-capabilities-staging */;
		NOXCUE_INGEST: Fetcher /* noxcue-staging */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PUBLIC_API_BASE_URL" | "PUBLIC_ASSET_BASE_URL" | "BUILD_SHA">> {}
}
